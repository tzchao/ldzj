...
$(function() {
    ...
    var cirLeft = $('.banner-click-box').width() * ( - 0.5);
    $('.banner-click-box').css({
        'marginLeft': cirLeft
    });
    ...
    function cirMove() {
        $('.banner-click-box li').eq(page - 1).addClass('selected').siblings().removeClass('selected');
    }
    ...
    $('.banner-click-box li').live('click',
        function() {
            var index = $('.banner-click-box li').index(this);
            $banner_ul.animate({
                    left: -v_width * index
                },
                'slow');
